...
Cloud Fire é uma plataforma demonstrativa de armazenamento em nuvem inspirada no MediaFire, criada para fins educativos e portfólio.
O sistema permite enviar, listar, visualizar e baixar arquivos armazenados em serviços compatíveis com Amazon S3, utilizando o Wasabi Hot Cloud Storage.
...
Exemplo da Configuração S3 (Wasabi) no Frontend:
export const S3_CONFIG = {
  endpoint: "https://s3.wasabisys.com",
  bucket: "cloud-fire-demo",
  region: "us-east-1",
};
...
Este projeto é totalmente educacional e serve apenas como demonstração técnica.
